    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>Jᴏɪɴ  ᴍʏ  ᴜᴘᴅᴀᴛᴇs  ᴄʜᴀɴɴᴇʟ  ᴛᴏ ᴜsᴇ ᴍᴇ 🔐</i>",
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='http://t.me/filestolinks007'>CLICK HERE FOR SUPPORT </a></b>",
                    parse_mode="HTML",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
...
<i><b>🍃 Bᴏᴛ Made Bʏ :</b>@unique_coders_x</i>\n\n
...
<b>Dont Spam.</b>""",
            ...
            reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('Owner', url=f"https://t.me/{Var.OWNER_USERNAME}"),
                                                                                       InlineKeyboardButton('Join ', url='https://t.me/unique_coders_x') ] ]  ) )
